...
public class JobServiceImpl implements JobService{
	...
	@Autowired
	private LoadStopDao loadStopDao;
	...
	/**
	 * Schedule a job by jobName By JobDataMap at given date.
	 */
	@Override
	public boolean scheduleCronJobByJobDataMap(String jobName, Class<? extends QuartzJobBean> jobClass, Date date, String cronExpression, JobDataMap jobDataMap) {
		System.out.println("Request received to scheduleJob");
		...
		JobDetail jobDetail = JobUtil.createJobByJobDataMap(jobClass, false, context, jobKey, groupKey, jobDataMap);
	...
	public List<Object[]> displayAllTrigger() {
		return loadStopDao.getAllTriggers();
	}
}
