...
import co.th.ford.tms.configuration.PersistableCronTriggerFactoryBean;
...
class JobUtil {
	...
	/**
	 * Create JobDetail By JobDataMap.
	 */
	protected static JobDetail createJobByJobDataMap(Class<? extends QuartzJobBean> jobClass, boolean isDurable, 
