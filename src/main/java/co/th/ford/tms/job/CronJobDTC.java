...
public class CronJobDTC extends QuartzJobBean implements InterruptableJob{
	private static Logger log = Logger.getLogger(CronJobDTC.class);
	...
	protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException  {
		log.info("=========> Start Execution Action : CronJobDTC. <==========");
