...
public class BaseForTaskScheduler {	
	
	//private static Logger log = Logger.getLogger(BaseForTaskScheduler.class);
	static final Logger log = Logger.getLogger("nostraLogger");
	
	public  String sendRequest(String wsEndpoint,String Authorization, String SOAPAction, String xmlInput, String systemLoadID, String descSendRequest) throws Exception {
		...
		log.info("HttpsURLConnection ResponseCode[ " + descSendRequest + " : " + httpConn.getResponseCode() + " By SystemLoad : " + systemLoadID + "].");
